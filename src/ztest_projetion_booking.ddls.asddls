...
define view entity ZTEST_PROJETION_BOOKING as projection on ZRAP_500_M_BOOKING {
...
@Consumption.valueHelpDefinition: [{entity.name:'ZTEST_M_TRAVEL',entity.element: 'Travel_Id' }]
key Travel_Id,
@Search.defaultSearchElement: true
...
@Consumption.valueHelpDefinition: [{entity.name:'ZRAP_500_I_AIRLINE',entity.element: 'Airline_Id' }]
Airline_Id,
@Search.defaultSearchElement: true
...
@Consumption.valueHelpDefinition: [{entity:{name:'ZRAP_500_I_FLIGHT',element: 'Flight_Number'},
...
_Customer,
_Flight,
_Travel:redirected to parent ZTEST_PROJECTION_TRAVEL
